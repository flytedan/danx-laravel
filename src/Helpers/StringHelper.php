...
class StringHelper
{
    ...
    /**
     * @param int $limit The maximum length of the string, first characters of the prefix will be removed (starting from the end of the string) to make room for the suffix
     * @param string $prefix
     * @param string $suffix
     * @param int $minPrefixLength If set, the prefix will be not be shortened (starting from the end) any further than this length
     * @return string
     * @throws Exception
     */
     ...
     * Also limit the text to a max length. If the text is not safe / too long, convert it into a printable number of bytes.
     *
     * @param     $string
     * @param int $maxLength
     * @return string
