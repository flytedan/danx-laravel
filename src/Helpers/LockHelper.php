...
use Flytedan\DanxLaravel\Exceptions\LockException;
use Cache;
use Exception;
...
class LockHelper
{
     ...
     *
     * @param string $key The lock key. Will acquire a lock for anything using the same key
     * @param null $waitTime The amount of time to wait before throwing an exception
     * @param null $ttl The locks time-to-live. Lock will expire after this many # of seconds
     *
     * @throws Throwable
     */
    public static function acquire($key, $waitTime = LockHelper::WAIT_TIME, $ttl = LockHelper::TTL)
    {
